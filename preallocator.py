...
class Preallocator(object):
    ...
    def __init__(self, vmms: list) -> None:
    ...
    def update(self, vm: 'vm', num: int) -> None:
    ...
    def allocVM(self, vmName: str) -> Optional['vm']:
    ...
    def __create(self, vm: 'vm', cnt: int) -> None:
